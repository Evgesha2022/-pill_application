...
import{create_base_user, create_base_states, check_all_tab} from "./data/data.js"
if(!localStorage.getItem('user')) {create_base_user()} 
if(!localStorage.getItem('states')){create_base_states(); console.log("create_base_states")}
//const app =express();
